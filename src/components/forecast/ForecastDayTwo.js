...
function ForecastDayTwo(props) {

    const weatherInfo = props.daily[2].weather[0].main;
    const weatherDescription = props.daily[2].weather[0].description;
    ...
    return (
        <Grid item xs={2.5} className='forecast-container'>
            <Stack direction='column' spacing={0.5} justifyContent='center' alignItems='center'>
                <Typography variant='p' className='forecast-day'>{props.dayTwo}</Typography>
